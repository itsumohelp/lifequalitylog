        ...
        <div className="prose prose-slate prose-sm max-w-none space-y-6">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 text-slate-700 space-y-1 mt-2">
              <li>サークルへの参加情報（メンバーシップ、ロール）</li>
              <li>支出・収入の記録（金額、カテゴリ、タグ、メモ等）</li>
              <li>残高スナップショット</li>
          ...
          <section>
            ...
            <p className="text-slate-700 leading-relaxed mb-2">
              本サービスでは、ユーザーが明示的に操作した場合に限り、AI（Google
              Vertex AI / Gemini）を利用した傾向分析機能を提供します。
            </p>
            <ul className="list-disc pl-5 text-slate-700 space-y-1">
              <li>
                <strong>自動送信は行いません</strong>
                ：サービスがユーザーの同意なしに自動でAIへデータを送信することはありません。AIへの問い合わせは、ユーザーがフィード内の「昨日までの傾向をAIに聞いてみる」ボタンを押した場合にのみ実行されます。
              </li>
              <li>
                <strong>AIへの入力内容</strong>
                ：ユーザーが記録した支出・収入の金額および説明文、ならびに残高スナップショットをAIへの入力として使用します。生成されたコメントはフィード上に表示され、データベースに保存されます。
              </li>
              <li>
                <strong>タグはAI入力対象外</strong>
                ：支出・収入に付与されたタグはセンシティブ情報として扱い、AIへの入力には使用しません。
              </li>
            </ul>
            <p className="text-slate-700 leading-relaxed mt-3">
              なお、オプトイン機能「自動タグ付け」は
              <strong>AIを使用しません</strong>
              。同一サークル内の過去の支出記録（金額・日時）をもとに、本サービス独自のルールベースロジックでタグを提案する機能です。入力したタグ情報が外部サービスに送信されることは一切ありません。
            </p>
          </section>
